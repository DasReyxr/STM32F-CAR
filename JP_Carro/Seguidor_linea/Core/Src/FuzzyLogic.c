...
*/
  ...
  float x_Low = 30; // Example input for Low
  float x_mid = 40; // Example input for Mid
  float x_High = 60; // Example input for High
  ...
  // Medio x_m y_m
  float TS = (x_mid-x_lm0)*(1-y_mid)/2.0f;
  ...
  // Low and Mid
  float x_lm0 = (y_mid - Mid.L) * (Mid.C - Mid.L); // Derived from m_Mid1 
